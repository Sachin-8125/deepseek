    ...
    <div className={`flex flex-col justify-between bg-[#212327] pt-7 transition-all z-50 max-md:absolute
        ...
        <div>
            ...
            <div className={`flex items-center cursor-pointer group relative ${expand 
                ...
                : "justify-center h-10 w-10 mx-auto hover:bg-gray-500/30 rounded-lg"}`}>
                <Image className={expand ? "w-5" : "w-6.5"} src={expand ? assets.phone_icon : assets.phone_icon_dull} alt='' />
            ...
            {/* Profile Section */}
            <div onClick={user ? null : openSignIn} className={`flex items-center cursor-pointer mt-2 ${expand 
                ? 'hover:bg-white/10 rounded-lg p-2' 
                : 'justify-center h-10 w-10 mx-auto hover:bg-gray-500/30 rounded-lg'} gap-3 text-white/60 text-sm`}>
